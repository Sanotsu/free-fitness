...
Free-Fitness 是使用 flutter 开发的集运动跟练、饮食记录、日记编写等功能为一体的健身饮食管理 app。

此 app 适合运动健身、减肥增肌、随手记录等需求的人员。数据全部在本地，无需联网，且自定性比较灵活。

## 功能说明

最普遍对于保持健康身体的要求来说，是合理的饮食与锻炼。主要功能如下：

![主页面截图](_screenshots/1主页面截图.jpg)

### 运动模块

对于“运动”，本应的**运动模块**主要提供以下功能:
