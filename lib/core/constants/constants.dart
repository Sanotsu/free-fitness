...
const String appLogoImageUrl = 'assets/images/app-logo.png';
const String placeholderImageUrl = 'assets/images/no-image.png';
...
class CusLabel {
  ...
  CusLabel({required this.enLabel, required this.cnLabel, required this.value});
}
...
enum CusMeals { breakfast, lunch, dinner, other }
...
enum CusChartType { calory, macro }
...
List<CusLabel> servingTypeList = [
  CusLabel(enLabel: "100ml/100g", cnLabel: "100毫升/100克", value: "metric"),
  CusLabel(
